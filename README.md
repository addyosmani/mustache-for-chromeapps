...
* [Ashe](https://github.com/dfsq/Ashe) is a lightweight templating library which supports variable replacement, loops, conditions and new variables inline. It uses neither `eval` nor `new Function`

* [Distal](http://code.google.com/p/distal/) is another templating library free of `eval`

* [Sandboxing eval](http://code.google.com/chrome/extensions/trunk/sandboxingEval.html). You have the option to use `eval` and `new Function` inside a sandboxed iframe. e.g, in the manifest one could do:
